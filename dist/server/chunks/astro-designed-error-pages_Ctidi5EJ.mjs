import { an as NOOP_MIDDLEWARE_HEADER, ao as REDIRECT_STATUS_CODES, A as AstroError, ap as ActionsReturnedInvalidDataError, W as DEFAULT_404_COMPONENT } from './astro/server_DKiXh7V9.mjs';
