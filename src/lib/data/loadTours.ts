  ...
  return rows
    ...
    .map((r) => {
      ...
      return {
        ...
        thumbnailImagePath: getAssetUrl(normalizeAssetPath(r.thumbnail_image_path), { slug, entity: 'tour', kind: 'thumb' }),
        heroImagePath: getAssetUrl(normalizeAssetPath(r.hero_image_path), { slug, entity: 'tour', kind: 'hero' }),
        imageSlide1: getAssetUrl(normalizeAssetPath(r.image_path_slide1), { slug, entity: 'tour', kind: 'image' }) || normalizeAssetPath(r.image_path_slide1),
        imageSlide2: getAssetUrl(normalizeAssetPath(r.image_path_slide2), { slug, entity: 'tour', kind: 'image' }) || normalizeAssetPath(r.image_path_slide2),
